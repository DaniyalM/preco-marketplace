    ...
    */
    ...
    'connections' => [
        ...
        'platform' => [
            ...
            'charset' => env('DB_CHARSET', (env('DB_PLATFORM_CONNECTION', env('DB_CONNECTION', 'mysql')) === 'pgsql' ? 'utf8' : 'utf8mb4')),
            'collation' => env('DB_COLLATION', (env('DB_PLATFORM_CONNECTION', env('DB_CONNECTION', 'mysql')) === 'pgsql' ? null : 'utf8mb4_unicode_ci')),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
