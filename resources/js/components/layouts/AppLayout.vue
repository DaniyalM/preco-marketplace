                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="relative">
                            ...
                            >
                                <button
                                    type="button"
                                    class="flex w-full items-center gap-2 px-3 py-2 text-start text-sm hover:bg-muted"
                                    :class="{ 'bg-muted font-medium': themeStore === 'light' }"
                                    @click="setLight"
                                >
                                ...
                                <button
                                    type="button"
                                    class="flex w-full items-center gap-2 px-3 py-2 text-start text-sm hover:bg-muted"
                                    :class="{ 'bg-muted font-medium': themeStore === 'dark' }"
                                    @click="setDark"
                                >
                                ...
                                <button
                                    type="button"
                                    class="flex w-full items-center gap-2 px-3 py-2 text-start text-sm hover:bg-muted"
                                    :class="{ 'bg-muted font-medium': themeStore === 'auto' }"
                                    @click="setSystem"
                                >
